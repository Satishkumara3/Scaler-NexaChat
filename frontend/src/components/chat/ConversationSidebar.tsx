    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {/* Stories button placeholder */}
          <button 
            className="p-1.5 rounded-full hover:bg-white/5 transition-colors"
            title="Stories"
            onClick={() => alert("Stories feature is a placeholder.")}
          >
          ...
          {/* Linked devices button placeholder */}
          <button 
            className="p-1.5 rounded-full hover:bg-white/5 transition-colors"
            title="Linked Devices"
            onClick={() => alert("Linked Devices feature is a placeholder.")}
          >
